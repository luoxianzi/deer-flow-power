...
class DeerFlowClient:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            engine: Override the default model provider family (codex, claude, api_pool).
    ...
    def _get_runnable_config(self, thread_id: str, **overrides) -> RunnableConfig:
        ...
        configurable = {
            ...
            "engine": overrides.get("engine", self._engine),
    ...
    def _ensure_agent(self, config: RunnableConfig):
        ...
        logger.info(
            "Agent created: agent_name=%s, model=%s, engine=%s, thinking=%s",
            self._agent_name,
            model_name,
            engine,
            thinking_enabled,

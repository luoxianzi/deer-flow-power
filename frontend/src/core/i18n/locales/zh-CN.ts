...
export const zhCN: Translations = {
  ...
  inputBox: {
    ...
    engine: "引擎",
    engineCodex: "Codex (本地 CLI)",
    engineCodexDescription: "使用宿主机 Codex CLI 登录态与 ~/.codex/auth.json 额度",
    engineClaude: "Claude (本地 CLI)",
    engineClaudeDescription: "使用宿主机 Claude Code 登录态与本地 OAuth 交接",
    engineApiPool: "弹药库 (API Pool)",
    engineApiPoolDescription: "使用 API_POOL_BASE_URL 指向的标准 OpenAI 兼容代理池",
    searchModels: "搜索模型...",
    surpriseMe: "小惊喜",

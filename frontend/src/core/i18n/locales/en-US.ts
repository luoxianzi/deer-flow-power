...
export const enUS: Translations = {
  ...
  inputBox: {
    ...
    engine: "Engine",
    engineCodex: "Codex (Local CLI)",
    engineCodexDescription: "Use the host Codex CLI login and quota via ~/.codex/auth.json",
    engineClaude: "Claude (Local CLI)",
    engineClaudeDescription: "Use the host Claude Code login and local OAuth handoff",
    engineApiPool: "Ammo Pool (API Pool)",
    engineApiPoolDescription: "Use the standard OpenAI-compatible API pool from API_POOL_BASE_URL",
